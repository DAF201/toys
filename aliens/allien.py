...
number = 50
path1 = "python/toys/aliens/InkedScreenshot (77)_LI.jpg"  # 输入图一路径
path2 = "python/toys/aliens/alien.jpg"  # 输入外星人头路径
maskpath = 'python/toys/aliens/aliensmask_circle.jpg'  # mask存储路径
savepath = 'python/toys/aliens/target.jpg'  # 输出存储路径
scale = 10
